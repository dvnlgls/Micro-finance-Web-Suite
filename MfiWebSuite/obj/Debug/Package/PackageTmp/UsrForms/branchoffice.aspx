<%@ Page Title="Branch Office" Language="C#" MasterPageFile="~/MasterPages/default.Master" AutoEventWireup="true"
    CodeBehind="branchoffice.aspx.cs" Inherits="MfiWebSuite.UsrForms.branchoffice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $("#btnSave:not(.disabled)").click(function (event) {
            ...
            <div class="ho-details" id="viewRO" runat="server">
                ...
                <div id="editOff" runat="server">
                    <div class="ho-btn-wrap">
                        ...
                        <a class="btn gen-nodisplay" id="btnCancel" onclick="return false;">
                            Cancel</a>
                    </div>
                    
                </div>
            </div>
            <div class="ho-off" id="viewSubOff" runat="server">
                <div class="ho-title">
                    Villages under this office
                </div>
                <table class="table table-bordered ho-off-tbl of-vil-tbl">
                    <thead>
                        <tr>
                            <th class="off">
                                Village
