<%@ Page Title="Area Office" Language="C#" MasterPageFile="~/MasterPages/default.Master" AutoEventWireup="true" CodeBehind="areaoffice.aspx.cs" Inherits="MfiWebSuite.UsrForms.areaoffice" %>
    ...
    <div class="gen-container-1">
        ...
        <div class="ho-content" id="uxOffcontent" runat="server">
            ...
            <div class="ho-off" id="viewSubOff" runat="server">
                <div class="ho-title">
                    Branch Offices under this office
                </div>
